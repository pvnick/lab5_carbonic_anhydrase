...
The following equilibrium expression can be used to model Step \eqref{eqn:KEML_reaction}:
\begin{equation}\label{eqn:KEML_expression}
K_{EML}=\frac{\text{[CA$\cdot$Zn$\cdot$L]}}{\text{[CA$\cdot$Zn][L]}}
\end{equation}
Step \eqref{eqn:kd_reaction} yields the following differential rate law:
